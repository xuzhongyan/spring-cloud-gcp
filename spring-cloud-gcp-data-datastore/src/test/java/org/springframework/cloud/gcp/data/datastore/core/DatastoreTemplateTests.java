...
public class DatastoreTemplateTests {
	...
	public void saveAndAllocateIdTest() {
		...
		assertArgs(callsArgs,
				new MapBuilder<List, Integer>().put(Arrays.asList(writtenEntity1), 1)
						.put(Arrays.asList(writtenChildEntity2, writtenChildEntity3), 1)
						.put(Arrays.asList(writtenChildEntity5, writtenChildEntity6), 1)
						.put(Arrays.asList(writtenChildEntity4), 1).buildModifiable());
		verify(this.datastoreEntityConverter, times(1)).write(same(this.ob1), notNull());
	}
	...
	public void findAllTest() {
		...
		assertThat(this.datastoreTemplate.findAll(TestEntity.class)).contains(this.ob1,
				this.ob2);
	}
